  ...
  return (
    <aside className="sidebar">
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)', paddingLeft: '46px' }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--text-primary)' }}>{organization.name}</div>
          <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)', marginTop: 2 }}>{organization.plan} plan</div>
        </div>
